...
import static com.pentasecurity.tx.btc.util.Base58.newDigest;
 ...
 * <p>
 * You may want to consider working with {@link } instead, which
...
public class Base58 {
    ...
    public static byte[] decodeChecked( String input ) throws AddressFormatException {
        ...
        if ( decoded.length < 4 )
            throw new AddressFormatException.InvalidDataLength( "Output too short: " + decoded.length );
