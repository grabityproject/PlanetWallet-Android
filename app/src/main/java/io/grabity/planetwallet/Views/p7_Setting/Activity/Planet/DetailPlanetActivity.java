        ...
        if ( getSerialize( C.bundleKey.PLANET ) == null ) {
            ...
            viewMapper.textName.getViewTreeObserver( ).addOnGlobalLayoutListener( new ViewTreeObserver.OnGlobalLayoutListener( ) {
                ...
                public void onGlobalLayout( ) {
                    viewMapper.textName.getViewTreeObserver( ).removeOnGlobalLayoutListener( this );
                    if ( viewMapper.textName.getPaint( ).measureText( viewMapper.textName.getText( ).toString( ) ) + viewMapper.btnName.getWidth( ) >= viewMapper.planetView.getX( ) - viewMapper.btnName.getWidth( ) ) {
                        viewMapper.textName.setWidth( 750 );
                        viewMapper.textName.requestLayout( );
                    } else {
